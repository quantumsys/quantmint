...
Please follow standard github best practices: fork the repo, branch from the tip of develop, make some commits, and submit a pull request to develop. See the [open issues](https://github.com/quantumsys/quantmint/issues) for things we need help with!
...
Looking for a good place to start contributing? How about checking out some [good first issues](https://github.com/quantumsys/quantmint/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
`$GOPATH/src/github.com/quantumsys/quantmint `, and do all the work there.

For instance, to create a fork and work on a branch of it, One would:

  * Create the fork on github, using the fork button.
  * Go to the original repo checked out locally (i.e. `$GOPATH/src/github.com/quantumsys/quantmint`)
...
- create a development branch either on github.com/quantumsys/quantmint, or your fork (using `git remote add origin`)
